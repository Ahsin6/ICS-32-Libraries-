...
class gui():
    ...
    def __init__(self, host, port, gb=BoardClass()):
        ...
        self.root.title(" Tic Tac Toe con")
    ...
    def create_thread(self):
        print('hello')
        thread = threading.Thread(target=self.runS)
        thread.daemon = True
        thread.start()
    def runS(self):
    ...
    def click1(self):
        ...
        if self.gb.turn % 2 == 0  and self.gb.board[0][0] == ' ':
            self.gb.turn += 1
            self.display()
            self.gb.board[0][0] = self.gb.player1
            self.b1['text'] = self.gb.board[0][0]
            data = '1'
            self.socket.sendall(data.encode())
            if self.gb.isWinner(self.gb.turn) == False:
                messagebox.showinfo("TC", "Win XS!")
                self.disableboard()
                self.playAgain()
                self.gb.turn = 0
            elif self.gb.Boardfull(self.gb.turn) == False:
    ...
    def click2(self):
        if self.gb.turn % 2 == 0  and self.gb.board[0][1] == ' ':
            self.gb.turn += 1
            self.display()
            self.gb.board[0][1] = self.gb.player1
    ...
    def click3(self):
        if self.gb.turn % 2 == 0  and self.gb.board[0][2] == ' ':
            ...
            data = '3'
            self.socket.sendall(data.encode())
            self.gb.board[0][2] = self.gb.player1
    ...
    def click4(self):
        if self.gb.turn % 2 == 0  and self.gb.board[1][0] == ' ':
            ...
            data = '4'
            self.socket.sendall(data.encode())
            self.gb.board[1][0] = self.gb.player1
    ...
    def click5(self):
        if self.gb.turn % 2 == 0  and self.gb.board[1][1] == ' ':
            ...
            data = '5'
            self.socket.sendall(data.encode())
            self.gb.board[1][1] = self.gb.player1
    ...
    def click6(self):
        if self.gb.turn % 2 == 0  and self.gb.board[1][2] == ' ':
            ...
            data = '6'
            self.socket.sendall(data.encode())
            self.gb.board[1][2] = self.gb.player1
    ...
    def click7(self):
        if self.gb.turn % 2 == 0  and self.gb.board[2][0] == ' ':
            ...
            data = '7'
            self.socket.sendall(data.encode())
            self.gb.board[2][0] = self.gb.player1
    ...
    def click8(self):
        if self.gb.turn % 2 == 0  and self.gb.board[2][1] == ' ':
            ...
            data = '8'
            self.socket.sendall(data.encode())
            self.gb.board[2][1] = self.gb.player1
    ...
    def click9(self):
        if self.gb.turn % 2 == 0  and self.gb.board[2][2] == ' ':
            ...
            data = '9'
            self.socket.sendall(data.encode())
            self.gb.board[2][2] = self.gb.player1
